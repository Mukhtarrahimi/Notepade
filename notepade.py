...
def save_file():
    ...
    if current_file is None:
        ...
        with open(current_file, "w", encoding="utf-8") as file_output:
...
def toggle_dark_mode():
    ...
    if dark_mode:
        ...
        status_bar.config(bg="gray20", fg="white")
    else:
...
text_edit = tk.Text(root, undo=True, wrap="word")
...
status_bar = tk.Label(root, text="Line: 1 | Column: 0", anchor="w", bg="lightgray")
